...
> 最近更新: 2026-09-01 00:08 +08:00 | 更新者: Codex PM
...
- **hotfix/v0.4.48-web-durable-turn-tracking** (MERGE_PENDING): pending turn 写前日志、completion 基线、页面恢复和幂等消费已完成；161 tests、真实 `dt-portal` 恢复与刷新 E2E 通过。
  - **issue-web-trigger-result-not-collected** (RESOLVED): 缺失的 `Grok 4.6 · 3m 0s` 结果已归集到问答区；刷新后未重复，pending 正确关闭。
