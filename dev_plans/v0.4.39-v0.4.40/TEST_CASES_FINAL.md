...
| D-02 | GitHub Release 资产 | PASS | v0.4.40 wheel + sdist，远端 digest 与本地一致 |
| D-03 | 真实 `dt upgrade` | PASS | 本机 `0.4.39 → 0.4.40` |
| D-04 | 升级前后配置和 tunnel 哈希 | PASS | config 与 tunnel 集合 SHA-256 均未变化 |
